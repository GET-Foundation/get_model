...
checkpoint="/pmglocal/alb2281/get/get_ckpts/natac_checkpoint_best.pth"
output_dir="/pmglocal/alb2281/get/output/natac-zeroshot-astrocyte"
...
for sample in "${samples[@]}"; do
    run_name="gbm_zeroshot_gene_dea_${sample}_natac"
