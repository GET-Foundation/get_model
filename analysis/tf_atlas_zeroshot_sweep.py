...
# %%
pearson = metrics[['exp_pearson', 'peak_count_filter', 'motif_scaler']].pivot(
    index='peak_count_filter', columns='motif_scaler', values='exp_pearson')
# %%
...
# %%
spearman = metrics[['exp_spearman', 'peak_count_filter', 'motif_scaler']].pivot(
    index='peak_count_filter', columns='motif_scaler', values='exp_spearman')
# %%
# heatmap of pearson correlation
plt.figure(figsize=(5, 5))
# smaller font size for annot
...
# %%
r2 = metrics[['exp_r2', 'peak_count_filter', 'motif_scaler']].pivot(
    index='peak_count_filter', columns='motif_scaler', values='exp_r2')
# %%
# heatmap of pearson correlation
plt.figure(figsize=(5, 5))
# smaller font size for annot
