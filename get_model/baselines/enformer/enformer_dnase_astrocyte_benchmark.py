...
output_dir = "/pmglocal/alb2281/repos/get_model/get_model/baselines/enformer/preds/enformer_dnase_preds_astrocyte"
...
if __name__=="__main__":
  dnase_k562_indices = [76, 77, 78, 133]
  ...
  region_file = "/pmglocal/alb2281/repos/get_model/get_model/baselines/enformer/data/118.csv"
  ...
  for start in tqdm(range(0, len(region_df), BATCH_SIZE)):
    ...
    preds = compute_enformer_preds_on_batch(model, fasta_extractor, batch_df, dnase_k562_indices)
